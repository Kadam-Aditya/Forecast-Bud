...
urlpatterns = [
    ...
    path('export_csv', views.export_csv,name="export-csv1"),
    path('export-pdf', views.export_pdf,name="export-pdf1"),
    path('export-excel', views.export_excel,name="export-excel1"),
]